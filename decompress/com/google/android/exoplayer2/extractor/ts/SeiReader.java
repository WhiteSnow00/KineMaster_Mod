...
public final class SeiReader
{
    ...
    public void b(final ExtractorOutput extractorOutput, final TsPayloadReader.TrackIdGenerator trackIdGenerator) {
        for (int i = 0; i < this.b.length; ++i) {
            ...
            String s = format.a;
            if (s == null) {
                s = trackIdGenerator.b();
            }
            e.d(new Format.Builder().S(s).e0(w).g0(format.d).V(format.c).F(format.O).T(format.y).E());
            this.b[i] = e;
        }
    }
}
