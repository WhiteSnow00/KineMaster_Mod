...
public final class CommentFrame extends Id3Frame
{
    ...
    static {
        CREATOR = (Parcelable$Creator)new Parcelable$Creator<CommentFrame>() {
            public CommentFrame a(final Parcel parcel) {
                return new CommentFrame(parcel);
            }
            
            public CommentFrame[] b(final int n) {
    ...
    public CommentFrame(final String b, final String c, final String d) {
        super("COMM");
        this.b = b;
        this.c = c;
        this.d = d;
    ...
    public boolean equals(final Object o) {
        ...
        if (o != null && CommentFrame.class == o.getClass()) {
            ...
            if (!Util.c(this.c, commentFrame.c) || !Util.c(this.b, commentFrame.b) || !Util.c(this.d, commentFrame.d)) {
                b = false;
            }
            return b;
        }
