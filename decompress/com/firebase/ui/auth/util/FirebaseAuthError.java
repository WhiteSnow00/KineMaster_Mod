...
{
    private static final FirebaseAuthError[] $VALUES;
    ...
    private FirebaseAuthError(final String description) {
        this.description = description;
    }
    
    public static FirebaseAuthError fromException(final FirebaseAuthException ex) {
        try {
